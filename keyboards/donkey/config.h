...
#define PRODUCT "Donkey/TMK"
#define USBSTR_PRODUCT         'D', '\x00', 'o', '\x00', 'n', '\x00', 'k', '\x00', 'e', '\x00', 'y', '\x00'
 ...
 * convert to other keys on hold (z becomes ctrl when you hold it, and
